          ...
          {this.faqList.map((faq) => {
            return (
              <div
                ...
                onClick={() => this.handleFaqClick(faq.faqId)}
              >
                <div className='acc-title acc-text'>
                  <p>{faq.question}</p>
                  <div
                    className={
                      this.state.faq === faq.faqId ? 'rotate-icon' : ''
                    }
                  >
                    <Add></Add>
                  </div>
                </div>
                {this.state.faq === faq.faqId && (
                  <div className='acc-subtitle acc-text'>{faq.answer}</div>
                )}
              </div>
            )
          })}
            ...
            <form action='GET'>
              ...
              <div className='email-form'>
                ...
                <Button
                  className='submit'
                  endIcon={
                    <KeyboardArrowRight style={{ transform: 'scale(1.5)' }} />
                  }
                >
                  Get started
                </Button>
